...
var spaceWords =['moon','mars','pluto', 'vast','earth','gravity','jupiter'];
//Holds choosenWord
var choosenWord = "";
...
function reset()
{
	//Chooses word randombly from the spaceWords
	choosenWord = spaceWords[Math.floor(Math.random() * spaceWords.length)];
